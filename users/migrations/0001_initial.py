# Generated by Django 4.1.7 on 2023-05-11 15:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_pic', models.ImageField(blank=True, null=True, upload_to='stu_id_pics')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_pic', models.ImageField(blank=True, null=True, upload_to='lec_profile_pics')),
                ('departments', models.ManyToManyField(blank=True, to='main.department')),
